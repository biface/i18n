...
class TestRepository:
    ...
    @pytest.mark.parametrize("key", ["details", "paths", "domains", "languages", "translators", "authors"])
    ...
    @pytest.mark.parametrize("parameters, dictionary, control", [
        ...
        (None,
         ...
         ([["details", "name"], "i18n-tools test"],
          [["details", "version"], "1.0.0"])),
        (([["details", "name"], "i18n-tools test"], [["details", "version"], "1.0.0"]),
         {"domains": {"test": ["help", "error"]}},
         ([["details", "name"], "i18n-tools test"],
          [["details", "version"], "1.0.0"],
          [["domains", "test"], ["help", "error"]])),
        ((["details", {"name": "i18n-tools test", "version": "1.0.0"}],), None,
         ([["details", "name"], "i18n-tools test"],
          [["details", "version"], "1.0.0"])),
        (None,
         {"languages": {"source": "fr-FR",
                        "hierarchy": {"en": ["en-GB", "en-US", "en_IE"],
                                      "fr": ["fr-FR", "fr-BE"]},
                        "fallback": "en"}},
         ([["languages", "source"], "fr-FR"],
    ...
    @pytest.mark.parametrize("paths, value, expected", [
        ("detail", None, "detail is not a valid path or key"),
        (["details", "version"], 1.0, "['details', 'version'] : 1.0 is not a <class 'str'>"),
        (["paths", "modules"], {"test": ["help"]}, "['paths', 'modules'] : {'test': ['help']} is not a <class 'list'>"),
    ])
    ...
    @pytest.mark.parametrize("key, value, expected", [
        ...
        ("details", "i18n-tools",
         "details : i18n-tools must be a dictionary"),
    ])
