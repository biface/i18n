...
class TestBuildPath:
    ...
    def test_build_path(
        self, tmp_function_repository, conf_tests, module, sub_dirs, expected, verified
    ):
        base_path = (
...
class TestCreateDirectory:
    ...
    def test_create_directory(self, tmp_module_repository, dir_path):
...
class TestRepositoryWorkflow:
    ...
    def test_create_template(
        self, tmp_module_repository, module, domain, valid, exception
    ):
        if valid:
    ...
    def test_create_catalog(
        self, tmp_module_repository, module, language, domain, valid
    ):
        if valid:
            create_catalog(
    ...
    def test_fetch_template(
        self, tmp_module_repository, module, domain, content, valid
    ):
        if valid:
    ...
    def test_fetch_catalog(
        self, tmp_module_repository, module, language, domain, content, valid
    ):
        if valid:
    ...
    def test_fetch_dictionary(
        self, tmp_module_repository, module, domain, language, content, valid
    ):
        if valid:
    ...
    def test_update_catalog(
        self, conf_tests, tmp_module_repository, module, language, domain, data, valid
    ):
        if valid:
            update_catalog(
    ...
    def test_update_dictionary(
        self, tmp_module_repository, module, language, domain, data, valid
    ):
        if valid:
            update_dictionary(
                tmp_module_repository[4].get_repository(),
    ...
    def test_create_module_archive(self, tmp_module_repository, module, archive, valid):
        if valid:
            create_module_archive(
    ...
    def test_remove_template(self, tmp_module_repository, module, domain):
    ...
    def test_remove_catalog(self, tmp_module_repository, module, language, domain):
        catalog_file = (
    ...
    def test_remove_dictionary(self, tmp_module_repository, module, language, domain):
        dictionary_file = (
    ...
    def test_restore_module_from_archive(
        self, tmp_module_repository, module, archive, valid
    ):
        if valid:
            files_names = [
    ...
    def test_remove_with_failed_paths(self, tmp_module_repository):
        with pytest.raises(Exception):
            remove_template(
...
class TestBuildRepository:
    ...
    def test_build_repository(self, tmp_module_repository, modules, domains, languages):
    ...
    def test_verify_repository(self, tmp_module_repository):
        assert verify_repository(tmp_module_repository[4].get_repository()) == True


class TestAggregateDictionary:
    @pytest.mark.parametrize(
        "module, domain, valid, exception",
        [
    ...
    def test_aggregate_dictionaries(
        ...
        if valid:
            ...
            dictionary_path = build_path(
                tmp_module_repository[2][1] / module / "locales"
            )
...
class TestTranslationLangFile:
    ...
    def test_translation_lang_file(
        self, tmp_module_repository, module, domain, lang, valid, exception
    ):
...
class TestVerifyRepository:
    ...
    def test_verify_path_and_modules(
        self, tmp_module_repository, repository, modified_path, valid, exception
    ):
        config = tmp_module_repository[4]
    ...
    def test_verify_available_language(
        self, tmp_module_repository, languages, valid, exception
    ):
        if valid:
            _verify_available_languages(
    ...
    def test_verify_target_module(
        self, tmp_module_repository, module, valid, exception
    ):
        if valid:
    ...
    def test_verify_target_domain(
        self, tmp_module_repository, module, domain, valid, exception, msg_error
    ):
        if valid:
            _verify_target_domain(
                tmp_module_repository[4].get_repository(), module, domain
...
class TestUpdateJsonTranslation:
    @pytest.mark.parametrize(
    ...
    def test_update_json_translation(
        self, existing_translation, translation_data, expected_result
    ):
        assert (
